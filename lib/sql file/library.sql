...
CREATE TABLE `library`.`admin` ( `id` INT NOT NULL AUTO_INCREMENT , 
  `Admin` VARCHAR(120) NULL DEFAULT NULL ,  `Password` VARCHAR(100) NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;
